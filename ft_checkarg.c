...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/05 03:10:02 by rdi-russ          #+#    #+#             */
/*   Updated: 2022/03/03 19:15:15 by rdi-russ         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_checkargs(t_utils *utils)
{
	if (ft_listsize((*utils).stack_a) == 2)
		...
		ft_sorts_a(&(*utils).stack_a, &(*utils).stack_b, utils);
	else if (ft_listsize((*utils).stack_a) > 3
